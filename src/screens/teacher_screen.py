...
# teacher full guidelines => Teacher login , registration and others
def teacher_screen():
...
def teacher_tab_take_attendance():
    ...
    if not subjects:
        st.warning('You havent created any subject yet!, Please create subject first.' )
        return
...
def teacher_screen_login():
    ...
    st.header("Login your Account" , text_alignment='left')
   
    teacher_username = st.text_input("Enter username", placeholder='ananyaroy')

    teacher_pass = st.text_input("Enter password",type='password', placeholder="abc@976")
...
def register_teacher(teacher_username,teacher_name, teacher_pass , teacher_pass_confirm):
    ...
    if check_teacher_exists(teacher_username):
        return False, "username alrealy taken!"
...
def teacher_screen_register():
    ...
    with c2:
        if st.button("GO Back", type='tertiary',key='registerbackbtn',shortcut='control+backspace'):
            st.session_state['login_type'] = None
            st.rerun()
    # form----
    ...
    teacher_pass = st.text_input("Enter password",type='password', placeholder="abc@976")
    teacher_pass_confirm =st.text_input("Confirm your password",type='password', placeholder="abc@976")

    st.divider()
    # login and register btn columns ----
    btncol1 ,btncol2 = st.columns(2)

    with btncol1:
       if st.button("Register",type='tertiary',icon=':material/passkey:',shortcut='Enter',width='stretch'):
    ...
    with btncol2:
        if st.button("Login Instead",icon=':material/passkey:',shortcut='shift+Enter',width='stretch'):
            st.session_state.teacher_login_type='login'
